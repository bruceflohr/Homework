<?php
        ...
        if($_SERVER['REQUEST_METHOD'] === "GET") {
            if(isset($_GET['name'])) {
                ...
                $name = $_GET['name'];
                $errors[] = "Thank you for submitting your data";
            }
            ...
            if(isset($_GET['years'])){
                if(!is_numeric($_GET['years']) || $_GET['years'] < 0){
                    ...
                    $errors[] = "years must be a number less than 50";
                }else{
                    $years = $_GET['years'];
                }
            }
    ...
    <div class="container">
        ...
        <form class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="number" min="0" max="50" step="1" class="form-control" id="years" name="years" placeholder="Years Coding" required
                        value="<?= $years ?>"
                    >
                </div>
            </div>
